...
{
	String^ psUserName = Runtime2Cs_Logic::Singletonksim()->getUserName();
...
{
	return Runtime2Cs_Logic::Singletonksim()->getClientVersion();
}
...
AccountInfo getAccountInfo()
{
	...
	AccountInfoRef^ inforef = Runtime2Cs_Logic::Singletonksim()->getAccountInfo();
	if(inforef != nullptr)
	{
...
{
	xverbose_function();
	String^ psExInfo = Runtime2Cs_Logic::Singletonksim()->getUplodLogExtrasInfo();
...
{
	xverbose_function();
	String^ psfilePath = Runtime2Cs_Logic::Singletonksim()->getCrashFilePath(timespan);
...
{
	return Runtime2Cs_Logic::Singletonksim()->getNextNoopTime();
}
unsigned int getNoopInterval()
{
	return Runtime2Cs_Logic::Singletonksim()->getNoopInterval();
}

std::string getDeviceType()
{
	return String2stdstring(Runtime2Cs_Logic::Singletonksim()->getDeviceType());
}

std::string getCurLanguage()
{
	String^ curLanguage = Runtime2Cs_Logic::Singletonksim()->getCurLanguage();
