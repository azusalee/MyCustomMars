...
class TrafficStatistics {
  ...
  public:
    ...
    void Flush();
    void SetCallback(const boost_ksim::function<void (int32_t, int32_t, int32_t, int32_t)>& _func_report_flow);
  private:
  ...
  private:
    ...
    boost_ksim::function<void (int32_t wifi_recv, int32_t wifi_send, int32_t mobile_recv, int32_t mobile_send)> func_report_flow_;
