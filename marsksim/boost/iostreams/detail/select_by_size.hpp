...
//
//    using namespace mars_boost::utility;
//
//    case_<0> helper(bool);
//    case_<1> helper(int);
...
namespace mars_boost {} namespace boost_ksim = mars_boost; namespace mars_boost { namespace utility {
...
#define BOOST_SELECT_BY_SIZE(type_, name, expr) \
    ...
    BOOST_STATIC_CONSTANT( \
        type_, \
        name = \
            ( ::mars_boost::iostreams::detail::select_by_size< \
