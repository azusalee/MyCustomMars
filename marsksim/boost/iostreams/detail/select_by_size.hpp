...
//
//    using namespace mars_boost_ksim::utility;
//
//    case_<0> helper(bool);
//    case_<1> helper(int);
...
namespace mars_boost_ksim {} namespace boost_ksim = mars_boost_ksim; namespace mars_boost_ksim { namespace utility {
...
#define BOOST_SELECT_BY_SIZE(type_, name, expr) \
    ...
    BOOST_STATIC_CONSTANT( \
        type_, \
        name = \
            ( ::mars_boost_ksim::iostreams::detail::select_by_size< \
