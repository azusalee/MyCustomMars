 ...
 *
 * Defines the class mars_boost_ksim::iostreams::detail::path, for storing a 
...
public:
    ...
    // Constructor taking a mars_boost_ksim::filesystem2::path or
    // mars_boost_ksim::filesystem2::wpath
    ...
    // Constructor taking a mars_boost_ksim::filesystem3::path (boost filesystem v3)
    template<typename Path>
    ...
    // Assignment operator taking a mars_boost_ksim::filesystem2::path or
    // mars_boost_ksim::filesystem2::wpath
    ...
    // Assignment operator taking a mars_boost_ksim::filesystem3::path
    template<typename Path>
...
private:
    ...
    // For wide-character paths, use a mars_boost_ksim::filesystem::wpath instead of a
    // std::wstring
