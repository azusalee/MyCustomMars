...
// mars_boost_ksim::filesystem::path, mars_boost_ksim::filesystem::wpath, 
// and mars_boost_ksim::iostreams::detail::path (used to store either a std::string or a
// std::wstring).
    ...
    : detail::mapped_file_params_base 
{
    ...
    // with mars_boost_ksim::filesystem::wpath
...
private:
    ...
    friend struct mars_boost_ksim::iostreams::operations<mapped_file_source>;
public:
    ...
    explicit mapped_file_source( const Path& path,
                                 ...
                                 mars_boost_ksim::intmax_t offset = 0 );
...
private:
    ...
    mars_boost_ksim::shared_ptr<impl_type> pimpl_;
};
...
private:
    ...
    typedef basic_mapped_file_params<detail::path>  param_type;
    friend struct mars_boost_ksim::iostreams::operations<mapped_file >;
...
public:
    friend struct mars_boost_ksim::iostreams::operations<mapped_file_sink>;
...
mapped_file_source::mapped_file_source( 
    const Path& path, size_type length, mars_boost_ksim::intmax_t offset)
...
mapped_file_sink::mapped_file_sink(
    ...
    mars_boost_ksim::intmax_t offset, mapmode flags )
...
struct operations<mapped_file_source>
    : mars_boost_ksim::iostreams::detail::close_impl<closable_tag>
{
