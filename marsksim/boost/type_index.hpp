...
/// as a mars_boost::typeindex::type_index and mars_boost::typeindex::type_info.
...
/// BOOST_TYPE_INDEX_FUNCTION_SIGNATURE is used by mars_boost::typeindex::ctti_type_index class to
/// deduce the name of a type. If your compiler is not recognized
/// by the TypeIndex library and you wish to work with mars_boost::typeindex::ctti_type_index, you may
...
/// then a compile-time error will arise at any attempt to use mars_boost::typeindex::ctti_type_index classes.
///
...
/// \code mars_boost::typeindex::ctti_type_index::type_id<int>().pretty_name() \endcode
/// returns the following string:
/// \code "static const char *mars_boost::detail::ctti<int>::n() [T = int]" \endcode
/// and \code mars_boost::typeindex::ctti_type_index::type_id<short>().pretty_name() \endcode returns the following:
/// \code "static const char *mars_boost::detail::ctti<short>::n() [T = short]" \endcode
///
/// As we may see first 39 characters are "static const char *mars_boost::detail::ctti<" and they do not depend on
...
/// for `mars_boost::typeindex::ctti_type_index::type_id<int>().pretty_name()` and \code "short>::n() [T = short" \endcode
/// for `mars_boost::typeindex::ctti_type_index::type_id<short>().pretty_name()`.
///
...
#define BOOST_TYPE_INDEX_CTTI_USER_DEFINED_PARSING (0, 0, false, "")
    ...
    /// as a default mars_boost::typeindex::type_index.
    ///
    /// Could be a mars_boost::typeindex::stl_type_index, mars_boost::typeindex::ctti_type_index or 
    /// user defined type_index class.
    ///
    /// \b See mars_boost::typeindex::type_index_facade for a full description of type_index functions.
    typedef platform_specific type_index;
#elif defined(BOOST_TYPE_INDEX_USER_TYPEINDEX)
    // Nothing to do
#elif (!defined(BOOST_NO_RTTI) && !defined(BOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)) || defined(BOOST_MSVC)
    typedef mars_boost::typeindex::stl_type_index type_index;
#else 
    typedef mars_boost::typeindex::ctti_type_index type_index;
#endif

/// Depending on a compiler flags, optimal implementation of type_info will be used 
/// as a default mars_boost::typeindex::type_info.
///
/// Could be a std::type_info, mars_boost::typeindex::detail::ctti_data or 
...
/// C c1;
/// A* pc1 = &c1;
/// assert(mars_boost::typeindex::type_id<C>() == mars_boost::typeindex::type_id_runtime(*pc1));
/// \endcode
...
/// Function to get mars_boost::typeindex::type_index for a type T.
...
/// Function for constructing mars_boost::typeindex::type_index instance for type T. 
