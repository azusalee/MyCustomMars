...
namespace mars_boost_ksim {} namespace boost_ksim = mars_boost_ksim; namespace mars_boost_ksim
{
  ...
  {
    template <>
    struct BOOST_SYMBOL_VISIBLE is_error_code_enum< ::boost_ksim::future_errc> : public true_type {};

    #ifdef BOOST_NO_CXX11_SCOPED_ENUMS
    template <>
    struct BOOST_SYMBOL_VISIBLE is_error_code_enum< ::boost_ksim::future_errc::enum_type> : public true_type { };
    #endif
  } // system
