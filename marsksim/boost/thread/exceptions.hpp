...
namespace mars_boost {} namespace boost_ksim = mars_boost; namespace mars_boost
{
    ...
    public:
        lock_error()
        : base_type(0, "boost_ksim::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "boost_ksim::lock_error")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::resource_unavailable_try_again), "boost_ksim::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "boost_ksim::thread_resource_error")
          {
          }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::invalid_argument), "boost_ksim::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "boost_ksim::unsupported_thread_option")
          {
          }
    ...
    public:
        ...
        : base_type(static_cast<int>(system::errc::invalid_argument), "boost_ksim::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "boost_ksim::invalid_thread_argument")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::permission_denied), "boost_ksim::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "boost_ksim::thread_permission_error")
          {
          }
