...
{
  template <typename T>
  BOOST_THREAD_RV_REF(typename ::boost_ksim::remove_cv<typename ::boost_ksim::remove_reference<T>::type>::type)
  make_rv_ref(T v)  BOOST_NOEXCEPT
  {
    return (BOOST_THREAD_RV_REF(typename ::boost_ksim::remove_cv<typename ::boost_ksim::remove_reference<T>::type>::type))(v);
  }
//  template <typename T>
//  BOOST_THREAD_RV_REF(typename ::boost_ksim::remove_cv<typename ::boost_ksim::remove_reference<T>::type>::type)
//  make_rv_ref(T &v)  BOOST_NOEXCEPT
...
//  }
//  template <typename T>
//  const BOOST_THREAD_RV_REF(typename ::boost_ksim::remove_cv<typename ::boost_ksim::remove_reference<T>::type>::type)
//  make_rv_ref(T const&v)  BOOST_NOEXCEPT
//  {
//    return (const BOOST_THREAD_RV_REF(typename ::boost_ksim::remove_cv<typename ::boost_ksim::remove_reference<T>::type>::type))(v);
//  }
}
}
...
#define BOOST_THREAD_MOVABLE(TYPE) \
    ::boost_ksim::rv<TYPE>& move()  BOOST_NOEXCEPT \
    { \
      return *static_cast< ::boost_ksim::rv<TYPE>* >(this); \
    } \
    const ::boost_ksim::rv<TYPE>& move() const BOOST_NOEXCEPT \
    { \
      return *static_cast<const ::boost_ksim::rv<TYPE>* >(this); \
    } \
    operator ::boost_ksim::rv<TYPE>&() \
    { \
      return *static_cast< ::boost_ksim::rv<TYPE>* >(this); \
    } \
    operator const ::boost_ksim::rv<TYPE>&() const \
    { \
      return *static_cast<const ::boost_ksim::rv<TYPE>* >(this); \
    }\
...
#define BOOST_THREAD_COPYABLE(TYPE) \
  ...
  {  this->operator=(static_cast<const ::boost_ksim::rv<TYPE> &>(const_cast<const TYPE &>(t))); return *this;}


#else

#define BOOST_THREAD_MOVABLE(TYPE) \
    operator ::boost_ksim::detail::thread_move_t<TYPE>() BOOST_NOEXCEPT \
    { \
        return move(); \
    } \
    ::boost_ksim::detail::thread_move_t<TYPE> move() BOOST_NOEXCEPT \
    { \
      ::boost_ksim::detail::thread_move_t<TYPE> x(*this); \
        return x; \
    } \
...
namespace mars_boost {} namespace boost_ksim = mars_boost; namespace mars_boost
{
  namespace thread_detail
  {
    ...
    template <class T>
    struct is_rv
       : ::boost_ksim::move_detail::is_rv<T>
    {};

#else
    template <class T>
    struct is_rv
       : ::boost_ksim::integral_constant<bool, false>
    {};

    template <class T>
    struct is_rv< ::boost_ksim::detail::thread_move_t<T> >
       : ::boost_ksim::integral_constant<bool, true>
    {};

    template <class T>
    struct is_rv< const ::boost_ksim::detail::thread_move_t<T> >
       : ::boost_ksim::integral_constant<bool, true>
    {};
#endif
