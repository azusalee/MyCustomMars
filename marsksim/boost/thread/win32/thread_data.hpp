...
//#endif
        ...
        typedef mars_boost_ksim::intrusive_ptr<detail::thread_data_base> thread_data_ptr;
        ...
        struct BOOST_SYMBOL_VISIBLE timeout
        {
            ...
            bool relative;
            mars_boost_ksim::system_time abs_time;
            ...
            timeout(uintmax_t milliseconds_):
                ...
                relative(true)
            //,
            //    abs_time(mars_boost_ksim::get_system_time())
            {}

            timeout(mars_boost_ksim::system_time const& abs_time_):
                start(win32::GetTickCount64_()()),
                milliseconds(0),
                relative(false),
                abs_time(abs_time_)
