...
#define _InterlockedCompareExchange InterlockedCompareExchange
...
#else
                    ::boost_ksim::detail::win32::Sleep(0);
#endif
                }
                else
                {
#if BOOST_PLAT_WINDOWS_RUNTIME
                    ::boost_ksim::detail::win32::WaitForSingleObjectEx(::boost_ksim::detail::win32::GetCurrentThread(), milliseconds, 0);
#else
                    ::boost_ksim::detail::win32::Sleep(milliseconds);
#endif
                }
            }
            ...
            public:
                ...
                ~scoped_winrt_thread()
                {
                    if (m_completionHandle != ::boost_ksim::detail::win32::invalid_handle_value)
                    {
                ...
                {
                    BOOST_ASSERT(m_completionHandle != ::boost_ksim::detail::win32::invalid_handle_value);
