...
namespace mars_boost_ksim {} namespace boost_ksim = mars_boost_ksim; namespace mars_boost_ksim
{
    ...
    public:
        ...
        void lock_shared()
        {
            ...
            BOOST_VERIFY(timed_lock_shared(::boost_ksim::detail::get_system_time_sentinel()));
#else
        ...
        bool timed_lock_shared(mars_boost_ksim::system_time const& wait_until)
        {
            for(;;)
            {
                ...
                unsigned long const res=detail::win32::WaitForSingleObjectEx(semaphores[unlock_sem],::boost_ksim::detail::get_milliseconds_until(wait_until), 0);
...
#if defined BOOST_THREAD_USES_DATETIME
            BOOST_VERIFY(timed_lock(::boost_ksim::detail::get_system_time_sentinel()));
#else
        ...
        bool timed_lock(mars_boost_ksim::system_time const& wait_until)
        {
            for(;;)
            {
                ...
                #endif
                unsigned long const wait_res=detail::win32::WaitForMultipleObjectsEx(2,semaphores,wait_all,::boost_ksim::detail::get_milliseconds_until(wait_until), 0);
