...
namespace mars_boost_ksim {} namespace boost_ksim = mars_boost_ksim; namespace mars_boost_ksim
{
  ...
  shared_ptr<T const> static_shared_from_this(T const* that)
  {
    ...
    namespace detail
    {
        ...
        {
            typedef std::list<boost_ksim::condition_variable_any*> waiter_list;
            ...
            {
              unique_lock<boost_ksim::mutex> lk(this->mutex);
              if (has_value(lk))
              {
            ...
            bool has_value(unique_lock<boost_ksim::mutex>& )  const
            {
                return done && ! exception;
            }
            ...
            detail::shared_state_base
        {
            ...
            typedef typename conditional<boost_ksim::is_fundamental<T>::value,T,T const&>::type source_reference_type;
            typedef BOOST_THREAD_RV_REF(T) rvalue_source_type;
            typedef T move_dest_type;
#else
            typedef T& source_reference_type;
            typedef typename conditional<boost_ksim::thread_detail::is_convertible<T&,BOOST_THREAD_RV_REF(T) >::value, BOOST_THREAD_RV_REF(T),T const&>::type rvalue_source_type;
            typedef typename conditional<boost_ksim::thread_detail::is_convertible<T&,BOOST_THREAD_RV_REF(T) >::value, BOOST_THREAD_RV_REF(T),T>::type move_dest_type;
#endif
...
//    }
    ...
    public:
        ...
        {
          return shared_future<R>(::boost_ksim::move(*this));
        }
