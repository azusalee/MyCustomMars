...
{
    BOOST_STATIC_CONSTANT( bool, ct = mars_boost_ksim::is_class<T>::value || mars_boost_ksim::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = mars_boost_ksim::is_class<U>::value || mars_boost_ksim::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public mars_boost_ksim::conditional<

    mars_boost_ksim::is_convertible<T, U>::value && !mars_boost_ksim::is_convertible<U, T>::value,
    mars_boost_ksim::type_identity<U>,

    typename mars_boost_ksim::conditional<

        mars_boost_ksim::is_convertible<U, T>::value && !mars_boost_ksim::is_convertible<T, U>::value,
        mars_boost_ksim::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public mars_boost_ksim::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public mars_boost_ksim::conditional<
    mars_boost_ksim::is_pointer<T>::value || mars_boost_ksim::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public mars_boost_ksim::conditional<
    mars_boost_ksim::is_member_pointer<T>::value || mars_boost_ksim::is_member_pointer<U>::value,
