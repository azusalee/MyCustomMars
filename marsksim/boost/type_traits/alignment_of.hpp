...
struct alignment_of_impl
{
    ...
    BOOST_STATIC_CONSTANT(std::size_t, value =
        (::mars_boost_ksim::detail::alignment_logic<
            sizeof(::mars_boost_ksim::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
...
template <class T> struct alignment_of : public integral_constant<std::size_t, ::mars_boost_ksim::detail::alignment_of_impl<T>::value>{};
