...
{
   typedef is_polymorphic_selector< ::mars_boost_ksim::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::mars_boost_ksim::detail::is_polymorphic_imp<T>::value> {};
