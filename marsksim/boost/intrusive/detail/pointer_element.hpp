...
{
   typedef typename mars_boost_ksim::intrusive::detail::first_param<Ptr>::type type;
};
...
{
   typedef typename ::mars_boost_ksim::intrusive::detail::pointer_element_impl<Ptr>::type type;
};
