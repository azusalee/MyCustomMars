...
{
    typedef mars_boost_ksim::uint8_t type;
...
{
    typedef mars_boost_ksim::int8_t type;
...
{
    typedef mars_boost_ksim::uint16_t type;
...
{
    typedef mars_boost_ksim::int16_t type;
...
{
    typedef mars_boost_ksim::uint32_t type;
...
{
    typedef mars_boost_ksim::int32_t type;
...
{
    typedef mars_boost_ksim::uint64_t type;
...
{
    typedef mars_boost_ksim::int64_t type;
...
struct storage128_t
{
    mars_boost_ksim::uint64_t data[2];
