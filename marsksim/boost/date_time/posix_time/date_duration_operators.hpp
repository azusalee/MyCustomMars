...
namespace posix_time {
  ...
  inline
  ptime 
  operator+(const ptime& t, const mars_boost_ksim::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const mars_boost_ksim::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+(const ptime& t, const mars_boost_ksim::gregorian::years& y)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const mars_boost_ksim::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
