...
namespace traits {
   ...
   {
      typedef typename mars_boost::make_unsigned<T>::type type;
   };
   template <class T>
   ...
   * types this trait defaults to `mars_boost::make_unsigned<T>::type`.  For user defined types it simply asserts that
   ...
   */
   ...
   // \cond show_private
      : public make_unsigned_imp < T, mars_boost::is_integral<T>::value > 
      // \endcond
   {};
   // \cond show_private
   template <class T, bool intrinsic>
   ...
   */
   ...
   struct make_unsigned_or_unbounded
      // \cond show_private
      : public make_unsigned_or_unbounded_imp < T, mars_boost::is_integral<T>::value > 
      // \endcond
   {};
