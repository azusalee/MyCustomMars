...
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::boost_ksim::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::boost_ksim::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::boost_ksim::detail::InterlockedExchangeAdd
