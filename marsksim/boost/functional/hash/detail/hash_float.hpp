...
namespace mars_boost {} namespace boost_ksim = mars_boost; namespace mars_boost
{
    namespace hash_detail
    {
        ...
        {
            mars_boost::hash_detail::call_frexp<T> frexp;
            mars_boost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        mars_boost::static_log2<limits<T>::radix>::value
...
namespace mars_boost {} namespace boost_ksim = mars_boost; namespace mars_boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return mars_boost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
