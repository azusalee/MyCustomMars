...
namespace mars_boost_ksim {} namespace boost_ksim = mars_boost_ksim; namespace mars_boost_ksim
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME mars_boost_ksim::enable_if_c<
        ...
        {
            mars_boost_ksim::hash_detail::call_frexp<T> frexp;
            mars_boost_ksim::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        mars_boost_ksim::static_log2<limits<T>::radix>::value
...
namespace mars_boost_ksim {} namespace boost_ksim = mars_boost_ksim; namespace mars_boost_ksim
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return mars_boost_ksim::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
