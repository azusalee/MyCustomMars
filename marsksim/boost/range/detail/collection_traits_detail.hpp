...
// Default collection traits -----------------------------------------------------------------
            ...
            */
            ...
            struct default_container_traits
            {
                ...
                typedef typename
                    ::boost_ksim::mpl::if_< ::boost_ksim::is_const<ContainerT>,
                        const_iterator,
                        iterator 
...
// Pair container traits ---------------------------------------------------------------------
            ...
            struct pair_container_traits
            {
                ...
                typedef typename ::boost_ksim::detail::
...
// Array container traits ---------------------------------------------------------------
            ...
            */
            ...
            public:
                ...
                typedef typename
                    ::boost_ksim::mpl::if_< ::boost_ksim::is_const<T>,
                        const_iterator,
                        iterator 
                    >::type result_iterator;
            ...
            private:
                // resolve array size
                typedef typename
                    ::boost_ksim::remove_cv<value_type>::type char_type;
                typedef typename
...
// Pointer container traits ---------------------------------------------------------------
            ...
            {
                typedef typename
                    ::boost_ksim::remove_pointer<T>::type value_type;
