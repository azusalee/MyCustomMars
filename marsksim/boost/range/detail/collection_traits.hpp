...
//  collection_traits template class -----------------------------------------//
        ...
        */
        ...
        {
        private:
            typedef typename ::boost_ksim::mpl::eval_if<
                    ::boost_ksim::algorithm::detail::is_pair<T>, 
                        detail::pair_container_traits_selector<T>,
                        typename ::boost_ksim::mpl::eval_if<
                        ::boost_ksim::is_array<T>, 
                            detail::array_container_traits_selector<T>,
                            typename ::boost_ksim::mpl::eval_if<
                            ::boost_ksim::is_pointer<T>,
