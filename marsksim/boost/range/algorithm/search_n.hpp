...
search_n(ForwardRange& rng, Integer count, const Value& value)
{
    ...
    return range_detail::search_n_impl(mars_boost::begin(rng),mars_boost::end(rng), count, value);
}
         ...
         BinaryPredicate binary_pred)
{
    ...
    return range_detail::search_n_pred_impl(mars_boost::begin(rng), mars_boost::end(rng),
...
search_n(ForwardRange& rng, Integer count, const Value& value)
{
    ...
    return range_return<ForwardRange,re>::
        pack(range_detail::search_n_impl(mars_boost::begin(rng),mars_boost::end(rng),
                           count, value),
             rng);
}
