...
find_first_of(SinglePassRange1 & rng1, ForwardRange2 const & rng2)
{
    ...
    return std::find_first_of(mars_boost_ksim::begin(rng1),mars_boost_ksim::end(rng1),
...
find_first_of(SinglePassRange1& rng1, const ForwardRange2& rng2)
{
    ...
    return range_return<SinglePassRange1,re>::
        pack(std::find_first_of(mars_boost_ksim::begin(rng1), mars_boost_ksim::end(rng1),
                                mars_boost_ksim::begin(rng2), mars_boost_ksim::end(rng2)),
             rng1);
}
