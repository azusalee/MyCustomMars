...
mismatch(SinglePassRange1& rng1, const SinglePassRange2 & rng2)
{
    ...
    return ::boost_ksim::range_detail::mismatch_impl(
        ::boost_ksim::begin(rng1), ::boost_ksim::end(rng1),
        ::boost_ksim::begin(rng2), ::boost_ksim::end(rng2));
}
...
mismatch(SinglePassRange1& rng1, const SinglePassRange2& rng2, BinaryPredicate pred)
{
    ...
    return ::boost_ksim::range_detail::mismatch_impl(
        ::boost_ksim::begin(rng1), ::boost_ksim::end(rng1),
        ::boost_ksim::begin(rng2), ::boost_ksim::end(rng2), pred);
}
