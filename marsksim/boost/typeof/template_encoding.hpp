...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename mars_boost_ksim::type_of::push_back<V, mars_boost_ksim::mpl::size_t<ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<mars_boost_ksim::mpl::size_t<ID>, Iter> self_t;\
        typedef mars_boost_ksim::mpl::size_t<ID> self_id;\
        typedef Iter iter0;\
