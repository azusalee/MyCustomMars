...
# define BOOST_TYPEOF_INDEX(T) (sizeof(*mars_boost_ksim::type_of::encode_index((mars_boost_ksim::type_of::encode_counter<1005>*)0)))
...
# define BOOST_TYPEOF(expr) \
    mars_boost_ksim::type_of::msvc_typeid_wrapper<typeid(mars_boost_ksim::type_of::encode_start(expr))>::type

# define BOOST_TYPEOF_TPL(expr) typename BOOST_TYPEOF(expr)

# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
struct name {\
    enum {_typeof_register_value=sizeof(typeid(mars_boost_ksim::type_of::typeof_register_type<name>(expr)))};\
