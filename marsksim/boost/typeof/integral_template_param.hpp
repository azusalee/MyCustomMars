...
#define BOOST_TYPEOF_INTEGRAL_PARAM_ENCODE(This, n)\
    typedef typename mars_boost_ksim::type_of::encode_integral<\
        BOOST_PP_CAT(V, n),\
...
#define BOOST_TYPEOF_INTEGRAL_PARAM_DECODE(This, n)\
    typedef mars_boost_ksim::type_of::decode_integral<BOOST_TYPEOF_INTEGRAL_PARAM_GETTYPE(This), BOOST_PP_CAT(iter, n)> BOOST_PP_CAT(d, n);\
