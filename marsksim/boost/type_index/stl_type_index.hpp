...
/// \brief Contains mars_boost::typeindex::stl_type_index class.
///
/// mars_boost::typeindex::stl_type_index class can be used as a drop-in replacement 
/// for std::type_index.
///
...
/// is defined mars_boost::typeindex::ctti is usually used instead of mars_boost::typeindex::stl_type_index.
...
inline std::string stl_type_index::pretty_name() const {
    static const char cvr_saver_name[] = "mars_boost::typeindex::detail::cvr_saver<";
    ...
    const mars_boost::core::scoped_demangled_name demangled_name(data_->name());

    const char* begin = demangled_name.get();
    if (!begin) {
        mars_boost::throw_exception(std::runtime_error("Type name demangling failed"));
    }
