...
DEFINE_FIND_CLASS(KC2Java, "com/tencent/marsksim/stn/StnLogic")

namespace marsksim {
namespace stn {

extern boost_ksim::signals2::signal<void (ErrCmdType _err_type, int _err_code, const std::string& _ip, uint16_t _port)> SignalOnLongLinkNetworkError;
extern boost_ksim::signals2::signal<void (ErrCmdType _err_type, int _err_code, const std::string& _ip, const std::string& _host, uint16_t _port)> SignalOnShortLinkNetworkError;
