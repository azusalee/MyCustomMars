...
#endif
{
    ...
    longlink_->OnSend = boost_ksim::bind(&LongLinkTaskManager::__OnSend, this, _1);
    longlink_->OnRecv = boost_ksim::bind(&LongLinkTaskManager::__OnRecv, this, _1, _2, _3);
    longlink_->OnResponse = boost_ksim::bind(&LongLinkTaskManager::__OnResponse, this, _1, _2, _3, _4, _5, _6, _7);
    longlink_->SignalConnection.connect(boost_ksim::bind(&LongLinkTaskManager::__SignalConnection, this, _1));
}

LongLinkTaskManager::~LongLinkTaskManager() {
    xinfo_function();
    longlink_->SignalConnection.disconnect(boost_ksim::bind(&LongLinkTaskManager::__SignalConnection, this, _1));
...
void LongLinkTaskManager::ClearTasks() {
    ...
    MessageQueueksim::CancelMessage(asyncreg_.Get(), 0);
    lst_cmd_.clear();
}
...
void LongLinkTaskManager::__RunLoop() {
    ...
    if (!lst_cmd_.empty()) {
      ...
      MessageQueueksim::FasterMessage(asyncreg_.Get(),
                                  MessageQueueksim::Message((MessageQueueksim::MessageTitle_t)this, boost_ksim::bind(&LongLinkTaskManager::__RunLoop, this), "LongLinkTaskManager::__RunLoop"),
