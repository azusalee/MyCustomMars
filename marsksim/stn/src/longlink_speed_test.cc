...
LongLinkSpeedTest::LongLinkSpeedTest(const boost_ksim::shared_ptr<NetSourceksim>& _netsource): netsource_(_netsource)
    , selector_(breaker_) {
...
boost_ksim::shared_ptr<NetSourceksim> LongLinkSpeedTest::GetNetSourceksim() {
    return netsource_;
}
