...
class LongLinkSpeedTest {
  public:
    LongLinkSpeedTest(const boost_ksim::shared_ptr<NetSourceksim>& _netsource);
    ~LongLinkSpeedTest();
    ...
    boost_ksim::shared_ptr<NetSourceksim> GetNetSourceksim();
  private:
    boost_ksim::shared_ptr<NetSourceksim> netsource_;
