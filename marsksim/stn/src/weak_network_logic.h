...
public:
    SINGLETON_INTRUSIVE_ksim(WeakNetworkLogic, new WeakNetworkLogic, delete);
    boost_ksim::function<void (int _key, int _value, bool _is_important)> report_weak_logic_;
