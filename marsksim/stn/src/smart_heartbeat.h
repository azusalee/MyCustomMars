...
//    NetHeartbeatInfo& operator=(const NetHeartbeatInfo&);
  ...
  public:
    ...
    friend class SmartHeartbeatksim;
};

class SmartHeartbeatksim {
  public:
    boost_ksim::function<void (TSmartHeartBeatAction _action, const NetHeartbeatInfo& _heart_info, bool _fail_timeout)> report_smart_heart_;
