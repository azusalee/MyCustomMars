...
//    extern void SetShortlinkSvrAddr(const uint16_t port);
    ...
    //加了个断开连接的方法(iOS用，by lizihong)
    extern void (*DisConnectLonglink)();
    
    extern bool (*ProxyIsAvailable)(const marsksim::comm::ProxyInfo& _proxy_info, const std::string& _test_host, const std::vector<std::string>& _hardcode_ips);
