...
void changeActiveLogicksim(int activeState, ActiveLogicksim& activeLogic)
{
	switch(activeState)
	{
...
void testFunc(TestCaseInfo* m_testCaseInfo, NetType netType, bool isUserNameEmpty, int activeState, ActiveLogicksim& activeLogic, BaseScene& baseScene, unsigned long expectInterval)
{
	Hook();
	sg_NetInfo = netType;
