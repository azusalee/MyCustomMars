...
static void initLongLinkTaskManager (CMMLongLinkTaskManager& _longLinkTaskManager, LongLinkSvrPush& _longLinkSvrPush)
{
	...
	_longLinkTaskManager.funNotify = boost_ksim::bind(&LongLinkSvrPush::OnLongLinkResponse, &_longLinkSvrPush, _1, _2, _3);
	_longLinkTaskManager.funCallback = boost_ksim::bind(&CallBack, 0, _1, _2, _3, _4, _5, _6);
	_longLinkTaskManager.funAntiAvalancheCheck = boost_ksim::bind(Check, _1, _2, _3);
	...
	_longLinkTaskManager.LongLinkChannel().FuncNetworkReport = boost_ksim::bind(&OnLongLinkNetworkError, _1, _2, _3, _4, _5);
	_longLinkTaskManager.funNotifyNetworkError = boost_ksim::bind(&OnLongLinkNetworkError, _1, _2, _3, _4, _5);
}
...
PUBC_TEST(MMLongLinkTaskMangerTest, test2)
{
	...
	CMMNetSourceksim::SetDebugLongIP("127.0.0.100");
	CMMNetSourceksim::SetDebugLongPort(8090);
...
PUBC_TEST(MMLongLinkTaskMangerTest, test3)
{
	...
	CMMNetSourceksim::SetDebugLongIP("127.0.0.101");
	CMMNetSourceksim::SetDebugLongPort(8091);
...
PUBC_TEST(MMLongLinkTaskMangerTest, test4)
{
	...
	CMMNetSourceksim::SetDebugLongIP("127.0.0.102");
	CMMNetSourceksim::SetDebugLongPort(8092);
...
PUBC_TEST(MMLongLinkTaskMangerTest, test5)
{
	...
	CMMNetSourceksim::SetDebugLongIP("127.0.0.103");
	CMMNetSourceksim::SetDebugLongPort(8093);
	...
	CMMNetSourceksim::SetDebugLongIP("");// avoid debug long ip impact on other testcase 
