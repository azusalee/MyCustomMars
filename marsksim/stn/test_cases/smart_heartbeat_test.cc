...
bool (CDetour::* CDetour::Real_IsActive)() = (bool (CDetour::*)())&ActiveLogicksim::IsActive;
...
{
	m_testCaseInfo->m_TestCaseName = "inactive, after MMSmartHeartbeatksim::OnLongLinkEstablished(), use MinHeartInterval, if success, use the previous value";
	UtilFunc::del_files(getAppFilePath() + "/" + "config");
...
{
	m_testCaseInfo->m_TestCaseName = "inactive, after MMSmartHeartbeatksim::OnLongLinkEstablished(), use MinHeartInterval, if fail three times continuously, use MinHeartInterval, or use the previous value";
	UtilFunc::del_files(getAppFilePath() + "/" + "config");
...
{
	m_testCaseInfo->m_TestCaseName = "inactive, after MMSmartHeartbeatksim::OnLongLinkDisconnect(), use MinHeartInterval, if success, use the previous value";
	UtilFunc::del_files(getAppFilePath() + "/" + "config");
...
{
	m_testCaseInfo->m_TestCaseName = "inactive, after MMSmartHeartbeatksim::OnLongLinkDisconnect(), use MinHeartInterval, if fail three times continuously, use MinHeartInterval, or use the previous value";
	UtilFunc::del_files(getAppFilePath() + "/" + "config");
