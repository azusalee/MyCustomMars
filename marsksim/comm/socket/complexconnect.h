...
class MComplexConnectksim {
  public:
    virtual ~MComplexConnectksim() {}
...
class ComplexConnectksim {
  public:
    ComplexConnectksim(unsigned int _timeout /*ms*/, unsigned int _interval /*ms*/);
    ComplexConnectksim(unsigned int _timeout /*ms*/, unsigned int _interval /*ms*/, unsigned int _error_interval /*ms*/, unsigned int _max_connect);
    ~ComplexConnectksim();

    SOCKET ConnectImpatient(const std::vector<socket_address>& _vecaddr, SocketBreaker& _breaker, MComplexConnectksim* _observer = NULL,
                            marsksim::comm::ProxyType _proxy_type = marsksim::comm::kProxyNone, const socket_address* _proxy_addr = NULL,
  ...
  private:
    ComplexConnectksim(const ComplexConnectksim&);
    ComplexConnectksim& operator=(const ComplexConnectksim&);
