...
#define SERVICE_REGISTER(classname, coreservice, servicevisible, servicecreate) \
    BOOT_REGISTER_CHECK(classname, design_patterns_ksim::ServiceRegister(&design_patterns_ksim::ServiceCreater<classname>, &classname::ServiceName, &classname::DependServicesName,\
...
#define IMPLEMENT_SERVICE(classname, ...) \
    ...
    {\
        static std::set<std::string> s_dependservicesname = design_patterns_ksim::__ServicesNameSet<__VA_ARGS__>::Make();\
...
#define IMPLEMENT_CORE_SERVICE(classname) \
    ...
    const std::set<std::string>& classname::DependServicesName()\
    {\
        static std::set<std::string> s_dependservicesname = design_patterns_ksim::_ComputeCoreServiceDepend(classname::ServiceName());\
        return s_dependservicesname;\
    }
