...
static void jniLogException(JNIEnv* env)
{
    ...
    __android_log_write(ANDROID_LOG_WARN, "marsksim::jniexception", szbuffer);
}
...
jvalue __JNU_CallMethodByName(
    ...
    VarCache* cacheInastance = VarCache::Singletonksim();
...
jvalue JNU_CallStaticMethodByName(
    ...
    jclass _clazz = VarCache::Singletonksim()->GetClass(_env, className);
    ASSERT(_clazz != NULL);
...
jvalue JNU_CallStaticMethodByMethodInfo(JNIEnv* _env, JniMethodInfo methodInfo, ...) {
    ...
    jclass _clazz = VarCache::Singletonksim()->GetClass(_env, methodInfo.classname.c_str());
...
jvalue JNU_GetStaticField(JNIEnv* _env, jclass _clazz, const char* _name, const char* sig) {
    ...
    jfieldID fid = VarCache::Singletonksim()->GetStaticFieldId(_env, _clazz, _name, sig);
...
jvalue JNU_GetField(JNIEnv* _env, jobject obj, const char* _name, const char* sig) {
    ...
    jfieldID fid = VarCache::Singletonksim()->GetFieldId(_env, _clazz, _name, sig);
