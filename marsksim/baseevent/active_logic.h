...
{
public:
    SINGLETON_INTRUSIVE_ksim(ActiveLogicksim, new ActiveLogicksim, delete);
    boost_ksim::signals2::signal<void (bool _isForeground)> SignalForeground;
    boost_ksim::signals2::signal<void (bool _isactive)> SignalActive;

public:
    ActiveLogicksim();
    virtual ~ActiveLogicksim();
